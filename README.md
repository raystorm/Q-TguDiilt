...
- [Drift‑resistant](docs/dev/glossary.md#driftresistant-reasoning) architecture
...
and once the user selects one, starts a [side trip](docs/dev/glossary.md#side-trip) workflow to apply updates to 
