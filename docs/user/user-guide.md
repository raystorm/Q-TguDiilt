...
reviewing [handoffs](../dev/glossary.md#handoff), and steering multi‑profile workflows.
...
**MESSAGE.md**  
A structured request for parallel or isolated work, in a **[side trip](../dev/glossary.md#side-trip)**.
...
**Profiles are not simple [personas](../dev/glossary.md#persona).  
