...
```
.amazonq/rules/architecture/change-impact-analysis-project.md
```
...
- Modifying required/optional attributes
...
**Example: Too Large: Structural change + rename + workflow change in one phase**

**❌ Too large:**
- Structural change + rename + workflow change in one phase

**✅ Split into phases:**

**Phase 1: Type Structure Change**
- Make the requested structural change (add/rename field, etc)
- Update code to use the new structure
...
**User request:** "Update a shared data structure to support a new field."

**1. Architect analyzes:**
- Change type: structure change + rename (combined)
- Affected domains/modules identified
- Predicted breaks listed
- Risk: HIGH - recommend splitting

**2. Architect recommends:**
- Phase 1: Structural change
- Phase 2: Rename
- Phase 3: Workflow or behavior change (if applicable)

**3. Tactician sequences:**
- Phase 1: Architect → PromptEngineer → Builder → Enforcer → Documentor
- Phase 2: PromptEngineer → Builder → Enforcer → Documentor
- Phase 3: PromptEngineer → Builder → Enforcer → Documentor

**4. PromptEngineer creates Builder prompt (Phase 1):**
- Implements the structural change
- Includes validation checklist
- Includes predicted breaks
- Includes phase boundaries

**5. Builder implements Phase 1:**
- Makes changes
- Runs validation checklist
- Reports: "All checklist items addressed"
- Hands off to Enforcer

**6. Enforcer validates Phase 1:**
- Checks validation checklist
- Runs available validation tools
- Runs tests
